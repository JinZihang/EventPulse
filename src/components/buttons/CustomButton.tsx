...
import {animateTiming, animateElastic, animateSpring} from './buttonAnimations';
import {styles, getStyles} from './buttonStyles';
...
export default function CustomButton({
  ...
  const renderContent = useMemo(() => {
    ...
    if (typeof children === 'string') {
      content = (
        <Text style={[styles.container__text, dynamicStyles.container__text]}>
          {children}
        </Text>
      );
    }
